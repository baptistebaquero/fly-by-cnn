...
def main(args):
    ...
    data_pred = FlyByDataset(df,device, dataset_dir=args.dir)
...
if __name__ == "__main__":
    ...
    input_group.add_argument('--num_agents',type=int, help=' umber of agents = number of maximum of landmarks in dataset', default=1)
    ...
    input_group.add_argument('--jsonfolder',type=str, help='path where you save your jsonfile after prediction')
